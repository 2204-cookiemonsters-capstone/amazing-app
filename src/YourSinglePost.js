...
const YourSinglePost = (props) => {
  ...
  const handleRemove = async () => {
    const reference = doc(firestore, "posts", post.postid);
    ...
    <RootSiblingParent>
      ...
      >
        ...
        >
          ...
          <TouchableOpacity onPress={() => handleRemove(post.postid)}>
            <EvilIcons name='trash' size={37} />
          </TouchableOpacity>
        </View>
