...
const TaskDashboard = ({
  ...
  return (
    <>
      <Text style={[styles.center, styles.fontWeight700, styles.subheading]}>
        Your {allUserTasks && allUserTasks[0] ? allUserTasks[0].month : null}{" "}
        Dashboard
      </Text>
        ...
        <View style={styles.userDashboard}>
          <View style={styles.dashboardRowTop}>
            <View style={styles.dashboardSetYourGoal}>
              <View>
                <Text
                  style={[styles.goalNum, styles.center, styles.fontWeight700]}
                >
                  Set Your Goal
                </Text>
                ...
                >
                  ...
                  <View style={styles.taskIconContainer}>
                    ...
                    {item.category === "creativity" ? (
                      <FontAwesome name='lightbulb-o' size={42} color='white' />
                    ) : null}
