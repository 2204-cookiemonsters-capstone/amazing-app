...
function TaskFriendsPosts({currentFriendUsername, friendsPosts}) {
  return (
    <View>
    ...
    <Text style={[styles.center, styles.padding10]}>no new posts to display</Text>
  </View>
  )
}

export default TaskFriendsPosts
